...
public final class ServicoCollectionRepository {
    ...
    static {
        ...
        Servico s2 = new SubstitucaoDePeca(1L, e1, 159.90, "Realizamos alimpeza das peças", LocalDateTime.now().minusHours(5), LocalDateTime.now().minusHours(4), LocalDateTime.now(), "Tela do Mobile");
